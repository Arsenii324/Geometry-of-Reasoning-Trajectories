...
`winding_null.csv`, `winding_variants_null.csv`, `manifold_null.csv`, `winding_permutation.csv`, `answer_probe.csv`, `regime_rederivation.csv`, `register_analysis.csv`, `register_window_recheck.csv`. Not yet produced (GPU-gated): `precision_check.csv`, `jacobian_spectrum.csv`, `register_probe.csv`, `depth_threshold.csv`.
