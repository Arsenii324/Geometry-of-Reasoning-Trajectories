...
| A18 | **DR3 METHOD 2 — implicit-differentiation attribution** via (I−J)⁻¹∂F/∂e as a Neumann series (~30–40 JVPs, geometric from ρ≈0.83). DR3 calls it *"the novel, publishable core… sound, cheap, artefact-free, and unclaimed in the literature"*. Same as B5, restated here because it is the one DR3 recommendation never started. | ~1 run | exact input attribution without BPTT; cross-validates D113 | `open, HIGH` |
