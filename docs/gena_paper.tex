...
> Gera Drobierro:
} Each token's latent path falls into one of several regimes—settling, looping, or drifting—distinguishable via Lyapunov exponents, recurrence, and persistent homology signatures.
